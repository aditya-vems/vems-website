...
export function Footer() {
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4 border-t border-muted border-dashed pt-8 text-base text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
